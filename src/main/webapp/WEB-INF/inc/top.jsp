...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<%=request.getContextPath() %>/">study home</a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="<%=request.getContextPath() %>/corona/corona.wow">코로나현황</a></li>
						<li><a href="#">공지사항</a></li>
				...
				<c:if test="${sessionScope.USER_INFO ne null }">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a href="<%=request.getContextPath()%>/login/logout.wow"> <span
