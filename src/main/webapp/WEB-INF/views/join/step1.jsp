			...
			<div class="row col-md-8 col-md-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<label> 이용약관 동의 <span class="required">(필수)</span>
							<form:checkbox path="agreeYn" value="Y" checked="checked"/>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<form:checkbox path="privacyYn" value="Y" checked="checked"/>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<label> 이벤트 등 프로모션 알림 메일 수신 <span class="optional">(선택)</span>
							<form:checkbox path="eventYn" value="Y" checked="checked"/>
						</label>
					</div>
					<div class="panel-body">
